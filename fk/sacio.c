...
*	sac_head_index	find the index of a sac head field.
  ...
  Modify history:
	...
	02/17/17	Lupei Zhu	revise sac_head_index() to include all 132 fields in the sac head for saclst

  Please see LICENSE file for copywright and license information.
